                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="ruc" class="form-control col-lg-1 col-md-4 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12" >RAZON_SOCIAL: </label>
                                    <input type="text" name="razon_social" class="form-control col-lg-3 col-md-10 col-sm-12" required>
                                </div>
                                <div class="form-group row">
