                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="usuario" class="form-control col-lg-2 col-md-4 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12" >TIPO_REPORTE: </label>
                                    <input type="text" name="tipo_reporte" class="form-control col-lg-2 col-md-10 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12">FECHA_INICIO: </label>
                                    <input type="date" name="fecha_inicio" class="form-control col-lg-1 col-md-10 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12">FECHA_FIN: </label>
                                    <input type="date" name="fecha_fin" class="form-control col-lg-1 col-md-10 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12" >FECHA_HORA_REPORTE: </label>
                                    <input type="date" name="fecha_hora_reporte" class="form-control col-lg-1 col-md-4 col-sm-12" required>
                                </div>
                                <div class="form-group row">
