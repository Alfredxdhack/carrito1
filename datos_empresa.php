        ...
        <div class="page-content">
            <div class="container-fluid">    <!-- container= solo una partede la pantalla container-fluid=todo el espacio extremo a extremo -->
                <div class="row">     <!-- ayuda en resposive -->
                    <div class="col-12">
                    <h4>REGISTRAR DATOS DE LA EMPRESA</h4>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="telefono" class="form-control col-lg-8 col-md-10 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12" >REPRESENTANTE: </label>
                                    <input type="text" name="representante" class="form-control col-lg-4 col-md-4 col-sm-12" required>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-md-2 col-sm-12" >LOGO: </label>
                                    <input type="text" name="logo" class="form-control col-lg-4 col-md-4 col-sm-12" required>
                                </div>
                                <div class="form-group row">
